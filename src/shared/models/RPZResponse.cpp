...
RPZResponse::RPZResponse(const snowflake_uid &answererTo, const ResponseCode &code, const QVariant &data) : Stampable() {
...
void RPZResponse::_setAnswerer(const snowflake_uid &answererStampableId) {
