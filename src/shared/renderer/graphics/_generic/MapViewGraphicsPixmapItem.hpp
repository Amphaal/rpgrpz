...
class MapViewGraphicsPixmapItem : public QObject, public QGraphicsPixmapItem, public RPZGraphicsItem {
 ...
 public:
    explicit MapViewGraphicsPixmapItem(const RPZAsset &assetMetadata) : QGraphicsPixmapItem(assetMetadata.filepath()) {}
    explicit MapViewGraphicsPixmapItem(const QString &filepath) : QGraphicsPixmapItem(filepath) {}
