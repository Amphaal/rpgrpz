...
class CharacterPicker : public QWidget, public ConnectivityObserver {
 ...
 public:
    ...
    CharacterPicker() : _characterListCombo(new QComboBox), _deleteCharacterBtn(new QPushButton), _newCharacterBtn(new QPushButton) {
        // add new character
 ...
 private:
    ...
    void _mayTooglePlaceholder() {
        ...
        } else if (itemCount == 0) {  // add placeholder
        ...
        } else {  // else, just make sure the combo is active
