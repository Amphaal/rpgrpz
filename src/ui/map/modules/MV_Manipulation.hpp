...
class MV_Manipulation {
 public:
    ...
    explicit MV_Manipulation(QGraphicsView* view) : _view(view) {
        ...
        this->_moveAnimator.setEasingCurve(QEasingCurve::OutCurve);
 ...
 protected:
    ...
    void focusItem(QGraphicsItem* toFocus) {
        ...
        } else {  // move whole view to fit at scale
