...
ConnectWidget::ConnectWidget(QWidget *parent) : QWidget(parent), _nameTarget(new QLineEdit(this)), _domainTarget(new QLineEdit(this)),
 _characterSheetTarget(new QComboBox(this)), _connectBtn(new QPushButton(this)) {
