...
class Translator_FR : public ITranslator {
    ...
    string Menu_About() { return "À Propos"; }
    string Menu_OpenLog() { return "Ouvrir le fichier de log complet"; };
    string Menu_OpenLatestLog() { return "Ouvrir le fichier de log de la session"; };
